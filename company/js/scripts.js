(function($){
  ...
  -------------------------------------------------------*/
  function squareDiv() {
    $('.work-item-description').width($('#square-div').width());
    $('.work-item-description').height($('#square-div').height());
  }
...
// $(".main-wrapper").after(
//   '<div id="customizer" class="s-close"><span class="corner"><i class="fa fa-cog"></i></span><div id="options" class="text-center"><a href="https://themeforest.net/user/deothemes?ref=DeoThemes" class="btn btn-md btn-color mt-40 mb-40"><span>Purchase Now</span></a><h6 class="uppercase">Select Demo</h6><ul class="demo-list clearfix">' +
