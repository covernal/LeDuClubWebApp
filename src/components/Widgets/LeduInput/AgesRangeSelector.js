...
class AgesRangeSelector extends React.Component{
  render() {
    return (
      <select className="form-control selectpicker show-tick" required={this.props.required} data-style="btn-default" value={this.props.value} onChange={this.props.handleChange}>
